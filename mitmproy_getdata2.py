...
class Counter:
    ...
    def response(self, flow: mitmproxy.http.HTTPFlow):
        ...
        # 音乐中心
        #https://aweme.snssdk.com/aweme/v1/music/detail/?music_id=6750989721029069576&click_reason=0&os_api=23&device_type=HUAWEI%20GRA-UL00&device_platform=android&ssmix=a&iid=91823970275&manifest_version_code=860&dpi=480&uuid=866696027819133&version_code=860&app_name=aweme&version_name=8.6.0&ts=1573474027&openudid=c39a97a0a010126c&device_id=37162856753&resolution=1080*1812&os_version=6.0&language=zh&device_brand=HUAWEI&app_type=normal&ac=wifi&update_version_code=8602&aid=1128&channel=huawei_1&_rticket=1573474031988
        if 'https://aweme.snssdk.com/aweme/v1/music/detail/' in url1:
            ...
            text = flow.response.get_text()
            json_data = json.loads(text, strict=False)
            # uid = json_data['music_info']['owner_id']
            # print(f'uid:{uid}')
            # print('*' * 100)
            dict1 = {
                # 'uid': uid,
